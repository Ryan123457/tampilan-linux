...
def logo():
    print("""
\033[44;1mHello Dunia Cyeber welcome\033[00;1m
\033[34;1m（\033[35;1m；\033[36;1m￣\033[32;1mェ\033[36;1m￣\033[34;1m）\033[32;1mTema Linux
  \033[37;1m[\033[32;1mAuthor:Mr-04\033[37;1m]
\033[37;1m[\033[32;1mMr-04\033[37;1m]
""")
...
def pasang():
    nama = input("Nama lu tod (bebas) : ")
    tema = open(".bashrc", 'w')
    tema.write("""
#Created By Mr04
clear
echo "
\033[31;1m█████████████████   \033[37;1m[\033[41;1mCracker Cyber Indonesia\033[00;1m\033[37;1m]
\033[31;1m█████████████████
...
"""% nama)
    ...
    print("\n\033[42;1mCracker Cyber Indonesia\033[00;1m")
...
def kembali():
    os.system("clear")
    exit("\033[34;1mCracker Cyber Indonesia")
main()
